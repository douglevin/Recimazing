//
//  RecipeDetailView+ViewModelTests.swift
//  RecimazingTests
//
...
class RecipeDetailViewViewModelTests {
    let mockURL: URL
    ...
    let viewModel: RecipeDetailView.ViewModel
    let recipe: Recipe
    ...
    init() throws {
        ...
        viewModel = RecipeDetailView.ViewModel(recipe: recipe, imageCloudClient: mockImageCloudClient)
    }
